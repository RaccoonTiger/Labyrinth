...
public class EnginDessinDonjon {
	...
	private Position convertirIJaPixel(Position ij){
		...
		ij.multiplierPos(new Position(LONGUEUR_CASE, LONGUEUR_CASE));
	 ...
	 * @param g2(Graphics2D), enginGraphic 2D java.swing
	 * @param donjon(donjon.Donjon), reference au donjon
	 */
	public void dessinerDonjon(Graphics2D g2, Donjon donjon){

		Case[][] cases = donjon.getCasesDonjon();
		// trace les murs
	 ...
	 * @param cetteCase(donjon.Case), case a afficher
	 */
